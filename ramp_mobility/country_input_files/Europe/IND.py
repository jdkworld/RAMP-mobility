...
tot_users = 20 # number of vehicles

#Variabilities 
r_w = {}

P_var = 0.1 #random in power
r_d   = 0.5 #random in distance
r_v   = 0.5 #random in velocity
...
occasional_use['saturday'] = 0
occasional_use['sunday'] = 0
occasional_use['free time'] = {'weekday': 0, 'weekend': 0} #1/7, meaning taking car for free time once a week
